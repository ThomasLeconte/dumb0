...
import {TableStatsDto} from "../../../commons/data/dto/table-stats-dto.js";
import {TableSizeDto} from "../../../commons/data/dto/table-size-dto.js";
import {TableRowsStatsDto} from "../../../commons/data/dto/table-rows-stats-dto.js";
import {TableLocksDto} from "../../../commons/data/dto/table-locks-dto.js";
import {TableIOStatsDto} from "../../../commons/data/dto/table-io-stats-dto.js";
import {TableIndexesDto} from "../../../commons/data/dto/table-indexes-dto.js";
import {SqliteService} from "./sqlite.service.js";
import {DatasourceDto} from "../../../commons/data/dto/datasource-dto.js";
import {DatasourceLockDto} from "../../../commons/data/dto/datasource-lock-dto.js";
import {DatasourceConnectionDto} from "../../../commons/data/dto/datasource-connection-dto.js";
import {DatasourceStatsDto} from "../../../commons/data/dto/datasource-stats-dto.js";
import {DatasourceMainStatsDto} from "../../../commons/data/dto/datasource-main-stats-dto.js";
    ...
    static async getDatasourceStats(args: { datasourceId: string }) {
        ...
        try {
            ...
            return new DatasourceStatsDto(
                pgStateStatementActivated,
                mainStats ?? new DatasourceMainStatsDto(0, 0, 0, '', ''),
                locks ?? [],
                connections ?? []
            );
        } catch (err) {
